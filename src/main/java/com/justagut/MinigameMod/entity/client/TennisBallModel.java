...
public class TennisBallModel<T extends TennisBall> extends HierarchicalModel<T> {
    ...
    @Override
    public void setupAnim(TennisBall entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
