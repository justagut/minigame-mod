...
public class MagmaBossAnimations {
    public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(0.7917F).looping()
            .addAnimation("armL1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            .addAnimation("lagR", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.4167F, KeyframeAnimations.degreeVec(5.0047F, 2.4905F, 0.218F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("armR1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.4167F, KeyframeAnimations.degreeVec(-12.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
    ...
    public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("armL1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(1.532F, 0.5416F, -2.4401F), AnimationChannel.Interpolations.CATMULLROM),
            ...
            .addAnimation("lagR", new AnimationChannel(AnimationChannel.Targets.POSITION,
            ...
            .addAnimation("armR1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(-0.1137F, -0.5383F, 2.4392F), AnimationChannel.Interpolations.CATMULLROM),
